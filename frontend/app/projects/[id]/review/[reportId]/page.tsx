      ...
      <div className="flex gap-4 h-[calc(100vh-160px)]">
        ...
        {selected ? (
          <div className="flex-1 bg-white border border-gray-200 rounded-xl p-5 overflow-y-auto flex flex-col gap-5">
            {/* A: Signal text */}
            <div>
              <div className="text-xs font-semibold text-gray-400 uppercase mb-2">A — Signal</div>
              ...
              {!showNewThread ? (
                ...
                <div className="flex gap-2 mt-2">
                  <input
                    ...
                    autoFocus
                  />
                  <button onClick={handleCreateThread} className="bg-gray-900 text-white text-sm px-3 py-1.5 rounded-lg">
                    Create & Assign
                  </button>
